          ...
          <wd-cell-group border>
            ...
            <template
              v-if="
                ...
                record.detail.type === 'bottle'
              "
            >
              <wd-cell title="奶类型" :value="bottleTypeText" />
              <wd-cell
                title="奶量"
                :value="`${record.amount} ${record.detail.unit || 'ml'}`"
              />
              <wd-cell
            ...
            <template
              v-if="
                record.feedingType === 'food' && record.detail.type === 'food'
              "
            >
              <wd-cell
                title="辅食名称"
                :value="record.detail.foodName || '未知'"
              />
            </template>
...
import {
  apiGetFeedingRecordById,
  apiDeleteFeedingRecord,
  apiUpdateFeedingRecord,
} from "@/api/feeding";
